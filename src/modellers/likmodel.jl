...
MCMCLikelihoodModel( lik::Function; args...) = 
	MCMCLikelihoodModel(lik, nothing, nothing; args...)
MCMCLikelihoodModel( lik::Function, grad::Function; args...) = 
	MCMCLikelihoodModel(lik, grad, nothing; args...)

# Model creation : gradient+hessian version 
function MCMCLikelihoodModel(	lik::Function, 
	...
	MCMCLikelihoodModel(lik, grad, hessian, init, scale, pmap)
end
